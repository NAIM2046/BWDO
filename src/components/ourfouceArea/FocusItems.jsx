...
export const focusDetailsList = [
  // 🌿 Environment
  {
    ...
    heroImage: "https://i.ibb.co.com/HfHyTxJ9/480847457-643553344899174-5690844239023994956-n.jpg",
    ...
    ourWork: {
      ...
      initiatives: [
        ...
        },
        {
          ...
          image: "https://images.unsplash.com/photo-1573148166680-db30ccb0b99e?w=500&h=300&fit=crop",
        },
        {
      ...
      initiatives: [
        {
          ...
          image: "https://images.unsplash.com/photo-1588514899090-e1c35ee50d92?w=500&h=300&fit=crop",
        },
        {
          ...
          image: "https://images.unsplash.com/photo-1591123120676-1ffad7e4ab6a?w=500&h=300&fit=crop",
        },
      ],
    },
  ...
  // 🎓 Education
  {
    ...
    heroImage: "https://i.ibb.co.com/v6MwsCQf/480451013-642901038297738-2316923828926509337-n.jpg",
    ...
    ourWork: {
      ...
      initiatives: [
        ...
        },
        {
          ...
          image: "https://images.unsplash.com/photo-1497636577773-f1231844b336?w=500&h=300&fit=crop",
        },
        {
      ...
      initiatives: [
        {
          ...
          description: "We have organized drawing competitions on various cultural occasions to promote and preserve Bangladeshi artistic traditions.",
          image: "https://images.unsplash.com/photo-1541961017774-22349e4a1262?w=500&h=300&fit=crop"
        },
        {
          title: "Brotherhood Rock Fest 2018",
          description: "We arranged this musical event to celebrate the spirit of unity and cultural harmony among Bangladeshis.",
        ...
        },
        {
          ...
          description: "This concert was organized to support flood victims while showcasing Bangladeshi cultural performances.",
          image: "https://images.unsplash.com/photo-1460661419209-00c7d46c7bb6?w=500&h=300&fit=crop"
        }
      ]
    },
      ...
      initiatives: [
        {
          ...
          description: "Our ongoing blood donation initiative ensures consistent availability of safe blood for surgical procedures, emergency accidents, and chronically ill patients, making a significant impact in healthcare delivery.",
          image: "https://images.unsplash.com/photo-1579684385127-937ef2e45db0?w=500&h=300&fit=crop"
        },
        {
          title: "COVID-19 Awareness Campaigns",
          description: "We launched comprehensive awareness campaigns educating people about the virus, prevention methods, and the importance of social distancing during the pandemic.",
          image: "https://images.unsplash.com/photo-1584036561566-baf8f5f1b144?w=500&h=300&fit=crop"
        },
        {
          title: "PPE Distribution Drive",
          description: "We distributed essential protective equipment including masks and hand sanitizers to thousands of people, enabling them to protect themselves and their families effectively.",
          image: "https://images.unsplash.com/photo-1584634731339-252c581abfc5?w=500&h=300&fit=crop"
        }
      ]
    },
  ...
  // ⚽ Sports
  {
    id: 6,
    title: "Sports",
    description: "Bangladesh faces several challenges in sports development, including inadequate facilities, limited access to training, insufficient funding, and lack of infrastructure that hinders the growth of athletic talent across the nation.",
    heroImage: "https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=1200&h=600&fit=crop",
      ...
      initiatives: [
        {
          ...
          description: "We have been actively organizing local sports tournaments to provide platforms for young athletes to showcase their talents and compete at various levels.",
          image: "https://images.unsplash.com/photo-1531415074968-036ba1b575da?w=500&h=300&fit=crop"
        },
        {
          title: "Athlete Training Programs",
          description: "We provide comprehensive training programs and mentorship to support young athletes in developing their skills and reaching their full potential.",
          image: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=500&h=300&fit=crop"
        },
        {
          title: "Resource Support for Athletes",
          description: "We supply necessary sports equipment, gear, and resources to underprivileged athletes who lack access to proper training facilities.",
          image: "https://images.unsplash.com/photo-1571019614244-c5c476dee238?w=500&h=300&fit=crop"
        }
      ]
    },
      ...
      initiatives: [
        {
          ...
          description: "We provide crucial support during emergencies and natural disasters, delivering essential supplies like food, clean water, medical aid, and temporary shelter to affected populations during crises including COVID-19 pandemic, floods, cyclones, and heatwaves.",
          image: "https://images.unsplash.com/photo-1583324113626-70b66b095d54?w=500&h=300&fit=crop"
        },
        {
          title: "Wall of Love - Clothing Distribution",
          description: "We have created 'Wall of Love' initiatives to provide clothing to those in need, ensuring people have basic necessities for dignity and protection.",
          image: "https://images.unsplash.com/photo-1583324113626-70b66b095d54?w=500&h=300&fit=crop"
        },
        {
          title: "Eid Gifts and Seasonal Support",
          description: "We distribute Eid gifts, food, and clothes to children and local communities during festive seasons, bringing joy and relief to underprivileged families.",
